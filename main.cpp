 ...
 * cela coute du temps, mais cela permet également de beaucoup pratiquer, et faire comme ça m'a permi de bien progresser en java
 *
 * La classe Labyrinthe diffère unpeu de celle de l'énoncé:
 *
 ...
 *      Le polymorphisme est ensuite utilisé pour distinguer la nature de chaque Bloc (Food, Wall, Door ou Bloc représentant le chemin)
 *
